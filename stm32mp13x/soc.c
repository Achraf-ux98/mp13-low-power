...
static const struct arm_mmu_region mmu_regions[] = {
	...
	MMU_REGION_FLAT_ENTRY("SYSRAM", 0x2FFE0000, 0x1C000,
			      MPERM_R | MPERM_W | MPERM_X | MT_NORMAL),

	MMU_REGION_FLAT_ENTRY("vectors", 0xC0000000, 0x1000, MPERM_R | MPERM_X | MT_NORMAL),

	/*
	 * Extra ROM mapping for SYSRAM section load images.
	 * Keep enough headroom to cover linker-placed LMA addresses beyond
	 * 0xC000A000 (e.g. 0xC000B104). 
	 */
	MMU_REGION_FLAT_ENTRY("rom_tail", 0xC0009000, 0x8000,
		      MPERM_R | MPERM_X | MT_NORMAL),
