...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DT_HAS_MICROCHIP_LAN8742_ENABLED, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DT_HAS_MICROCHIP_MCP23017_ENABLED, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DT_HAS_ST_MIPID02_ENABLED, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DT_HAS_ST_STM32MP13_CPU_CLOCK_MUX_ENABLED, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DT_HAS_ST_STM32MP13_ETHERNET_ENABLED, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DT_HAS_ST_STM32MP13_PLL_CLOCK_ENABLED, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_NUM_IRQS, 181);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SYS_CLOCK_HW_CYCLES_PER_SEC, 64000000);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_FLASH_SIZE, 262144);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_FLASH_BASE_ADDRESS, 0xc0000000);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BOARD_STM32MP135F_DK, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BOARD_STM32MP135F_DK_STM32MP135FXX, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SOC_SERIES_STM32MP13X, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SOC_STM32MP135FXX, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SRAM_BASE_ADDRESS, 0xd0000000);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_KERNEL_VM_BASE, 0xd0000000);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_KERNEL_DIRECT_MAP, 1);
